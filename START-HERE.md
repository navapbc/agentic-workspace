...
That creates a workspace from `templates/workspace/`: a thin root `AGENTS.md`, a `CLAUDE.md` that imports it (`@AGENTS.md`), a `README.md`, and a starter set of `docs/` lanes you can rename or replace.
