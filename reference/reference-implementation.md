...
| Portable bindings table | A `${...}` bindings table at the top of portable skills, resolved per machine |
...
2. **One sharing mechanism.** Decide git-backed or Drive-backed sharing per team and per phase, and finish wiring the one you pick. See [../docs/collaboration-and-governance.md](../docs/collaboration-and-governance.md).
