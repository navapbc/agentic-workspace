...
2. `canonical/benefits-notices/AGENTS.md` and the `product:benefits-notices` profile.
...
4. Save it to `canonical/benefits-notices/docs/plans/`.
...
Claude, Codex, OpenCode, and other harnesses produce the same brief shape. This canonical file controls behavior.
